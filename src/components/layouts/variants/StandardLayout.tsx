...
import { Box, Paper, Breadcrumbs, Typography, Link, Fab, Tooltip } from '@mui/material';
...
export default function StandardLayout({ children }: StandardLayoutProps) {
  const { layout, navbarPosition, sidebarStyle } = useSelector((state: RootState) => state.settings);
