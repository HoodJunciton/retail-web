  ...
  return (
    <Drawer
      ...
      ModalProps={{
        ...
        disableEnforceFocus: true, // Allow focus to move outside the drawer
        disableAutoFocus: true, // Don't auto-focus the first focusable element
        disableRestoreFocus: true, // Don't restore focus on close
      }}
      PaperProps={{
        sx: {
          width: 360,
          p: 3,
          boxShadow: (theme) =>
            `0 8px 10px -5px ${theme.palette.mode === "dark" ? "rgba(0, 0, 0, 0.3)" : "rgba(0, 0, 0, 0.2)"},
             0 16px 24px 2px ${theme.palette.mode === "dark" ? "rgba(0, 0, 0, 0.25)" : "rgba(0, 0, 0, 0.14)"},
             0 6px 30px 5px ${theme.palette.mode === "dark" ? "rgba(0, 0, 0, 0.2)" : "rgba(0, 0, 0, 0.12)"}`,
        },
      }}
      sx={{
                ...
                {[
                  ...
                  <Box key={theme}>
                    <ThemePreview
                      ...
                      onClick={() =>
                        handleThemeOptionChange(theme as ThemeOption)
                      }
                      darkMode={darkMode}
                    />
                  </Box>
